import argparse
import os
from data_utils.FrancavillaFontanaDataLoader import PointCloudDataset
import torch
import datetime
import logging
...
classes = ['0 Building','1 Platform','2 Rail','3 Vegetation','4 Sky','5 Other','6 Ground','7 Overhead_line']
...
def main(args):
	...
	if args.optimizer == 'Adam':
		optimizer = torch.optim.Adam(
			filter(lambda p: p.requires_grad, classifier.parameters()), # classifier.parameters(),
