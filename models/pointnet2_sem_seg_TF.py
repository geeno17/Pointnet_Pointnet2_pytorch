...
class get_model(nn.Module):
	...
	def forward(self, record):
		...
		learned_xyz = self.fp1(l0_xyz, l1_xyz, None, l1_points)

		l1_xyz, l1_points = self.sa_other_1(l0_xyz, l0_other)
		l2_xyz, l2_points = self.sa_other_2(l1_xyz, l1_points)
		l3_xyz, l3_points = self.sa_other_3(l2_xyz, l2_points)
		l4_xyz, l4_points = self.sa_other_4(l3_xyz, l3_points)

		l3_points = self.fp_other_4(l3_xyz, l4_xyz, l3_points, l4_points)
		l2_points = self.fp_other_3(l2_xyz, l3_xyz, l2_points, l3_points)
		l1_points = self.fp_other_2(l1_xyz, l2_xyz, l1_points, l2_points)
		learned_other = self.fp_other_1(l0_xyz, l1_xyz, None, l1_points)

		# learned_full = np.concat((leaned_xyz, learned_other),axis=1)
		# print(learned_xyz.shape)
		# print(learned_other.shape)
		learned_full = torch.cat((learned_xyz, learned_other), 1)
		# print(learned_full.shape)

		x = self.drop1(F.relu(self.bn1(self.conv1(learned_full))))
		x = self.conv2(x)
		x = F.log_softmax(x, dim=1)
		x = x.permute(0, 2, 1)
		return x, learned_full
