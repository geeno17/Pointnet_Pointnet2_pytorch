import argparse
import os
from data_utils.S3DISDataLoader import PointCloudDataset
import torch
import datetime
import logging
...
def parse_args():
	...
	parser.add_argument('--nchannel', type=int,  default=9, help='Point Number [default: 9]')
	parser.add_argument('--normal', action='store_true', default=False, help='Whether to use normal information [default: False]')
	parser.add_argument('--step_size', type=int,  default=10, help='Decay step for lr decay [default: every 10 epochs]')
	parser.add_argument('--lr_decay', type=float,  default=0.7, help='Decay rate for lr decay [default: 0.7]')
	parser.add_argument('--root', type=str, default='data', help='Data path [default: data]')
	parser.add_argument('--test_area', type=int, default=6, help='Test area [default: 6]')
...
def main(args):
	...
	TRAIN_DATASET = PointCloudDataset(split = 'train', testArea = args.test_area)
	...
	TEST_DATASET = PointCloudDataset(split = 'test', testArea = args.test_area)
